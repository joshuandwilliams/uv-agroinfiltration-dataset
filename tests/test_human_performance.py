...
class TestGenerateScorerKey:
    ...
    def sample_data(self) -> pd.DataFrame:
        ...
        """
        data = {"Scorer1": ["Alice", "Bob", "Charlie", "Alice", "Bob", "David"]}
        return pd.DataFrame(data)

    def test_generate_scorer_key_valid_data(
    ...
    def test_generate_scorer_key_random_state(
        self, sample_data: pd.DataFrame, tmp_path: Path
    ) -> None:
        """
...
class TestCmAccuracies:
    ...
    def setup_confusion_matrix(self) -> np.ndarray:
        ...
        """
        return np.array([[5, 2, 0], [1, 6, 1], [0, 2, 4]])
    ...
    def test_exact_accuracy(
        self, setup_confusion_matrix: np.ndarray, setup_class_labels: list
    ) -> None:
        """
    ...
    def test_within_one_accuracy(
        ...
        assert result["within_one_accuracy"] == pytest.approx(
            expected_within_one_accuracy, rel=1e-3
        )

    def test_per_class_accuracies(
        self, setup_confusion_matrix: np.ndarray, setup_class_labels: list
    ) -> None:
        """
        ...
        """
        result = cm_accuracies(setup_confusion_matrix, setup_class_labels)
        expected_class_accuracies = {"Class 0": 5 / 7, "Class 1": 6 / 8, "Class 2": 4 / 6}
...
class TestExtractScorePairs:
    ...
    def test_no_missing_values(self):
        ...
        expected_data = [(10, 20), (10, 30), (20, 30), (40, 50), (40, 60), (50, 60)]
    ...
    def test_with_missing_values(self):
        data = {"Score1": [10, 40, 70], "Score2": [20, np.nan, np.nan], "Score3": [30, 60, 90]}
        input_df = pd.DataFrame(data)

        expected_data = [(10.0, 20.0), (10.0, 30.0), (20.0, 30.0), (40.0, 60.0), (70.0, 90.0)]
        expected_df = pd.DataFrame(expected_data, columns=["ScoreA", "ScoreB"])
